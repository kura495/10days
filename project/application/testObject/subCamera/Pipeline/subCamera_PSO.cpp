#include "subCamera_PSO.h"

void subCamera_PSO::ShaderCompile()
{
	vertexShaderBlob = ShaderCompiler::GetInstance()->CompileShader(L"project/resources/hlsl/FullScreen.VS.hlsl", L"vs_6_0");
	assert(vertexShaderBlob != nullptr);
	pixelShaderBlob = ShaderCompiler::GetInstance()->CompileShader(L"project/resources/hlsl/FullScreen.PS.hlsl", L"ps_6_0");
}

void subCamera_PSO::CreateRootSignature()
{
...
void subCamera_PSO::CreateInputLayOut()
{
	inputLayoutDesc.pInputElementDescs = nullptr;
	inputLayoutDesc.NumElements = 0;
}

void subCamera_PSO::CreateBlendState()
{
	//NormalBlendに設定
...
void subCamera_PSO::CreateRasterizarState()
{
	rasterizerDesc.CullMode = D3D12_CULL_MODE_BACK;
	rasterizerDesc.FillMode = D3D12_FILL_MODE_SOLID;
}

void subCamera_PSO::CreatePipelineStateObject()
{
